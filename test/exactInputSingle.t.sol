...
contract TestExactInput is Test {
    ...
    function testExactInputSingle() public {
        ...
        // Define parameters for exactInputSingle
        uint24 fee = 500; // Example fee tier
        uint160 sqrtPriceLimitX96 = 1956260967287247098961477920037032; // (sqrtPrice before + sqrtPrice after) / 2
        ...
        emit log_named_uint("Final WETH balance of Alice", finalAliceWethBalance);
